...
func _update_pause_info() -> void:
	var initiator_peer_id := (
		Netcode.frame_driver
			._pause_initiator_peer_id)
	var initiator_pauses_used := (
		Netcode.frame_driver
	...
	_can_local_peer_unpause = (
		_check_if_local_peer_can_unpause(
			initiator_peer_id))
...
func _check_if_local_peer_can_unpause(
