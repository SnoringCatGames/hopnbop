...
func _input(event: InputEvent) -> void:
	if event.is_action_just_pressed("toggle_annotations"):
	...
	elif event.is_action_just_pressed("toggle_hud"):
	...
	elif event.is_action_just_pressed("toggle_music"):
	...
	elif event.is_action_just_pressed("take_screenshot"):
		if G.network.is_preview:
			G.utils.take_screenshot()
	elif event.is_action_just_pressed("toggle_perf_tracker"):
	...
	elif event.is_action_just_pressed("toggle_debug_console"):
	...
	elif event.is_action_just_pressed("toggle_debug_player_state"):
	...
	elif event.is_action_just_pressed("toggle_pause"):
